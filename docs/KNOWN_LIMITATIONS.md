...
- The current public build has 7/8 tracked evidence-field classes complete and 1/8 partial: Rubick `8867351572` has 7/7 real death times but only 4/7 source-backed death coordinates. Those three unlocated deaths are not assigned map coordinates or used as location evidence.
